    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('genres', models.ManyToManyField(blank=True, null=True, related_name='books', to='library.genres')),
                ('publisher', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='books', to='library.publisher')),
                ('series', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='books', to='library.series')),
            ],
        ),
        migrations.CreateModel(
            name='Lists',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('owner_list', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='library.lists')),
            ],
        ),
        migrations.CreateModel(
            name='Review',
